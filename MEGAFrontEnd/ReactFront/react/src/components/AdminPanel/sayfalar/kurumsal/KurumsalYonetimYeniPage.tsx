...
const CREATE_URL = "/api/kurumsal/yonetim/create"; // Backend yolunuzu burada güncelleyebilirsiniz
...
export default function KurumsalYonetimYeniPage() {
    ...
    const [form, setForm] = useState({
        ...
        mudurlukler: "",
        resimUrl: "",
        delta: 1 as 1 | 0, // 1: aktif, 0: pasif
    });
    ...
    async function onPick(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            setForm((s) => ({ ...s, resimUrl: url })); // URL otomatik
        } catch (er: any) {
    ...
    return (
        <div className="mx-auto max-w-[1100px]">
            ...
            {/* Hata */}
            {error && (
                <div className="mb-4 rounded-lg border border-red-200 bg-red-50 px-4 py-2 text-red-700">{error}</div>
            )}
            ...
            <form onSubmit={submit} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setForm({ ...form, isimSoyisim: e.target.value })}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                className={input}
                                placeholder="Örn: Kültür İşleri"
                                value={form.mudurlukler}
                                onChange={(e) => setForm({ ...form, mudurlukler: e.target.value })}
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                id="aktif"
                                type="checkbox"
                                checked={form.delta === 1}
                                onChange={(e) => setForm({ ...form, delta: e.target.checked ? 1 : 0 })}
                            />
                    ...
                    <div className="space-y-3">
                        ...
                        {/* Yalnızca okunur: metin girişi kapalı, upload ile dolar */}
